...
public class DBProcesses {
	...
	public void createPersonelTable(){
		...
		try {
			...
			preparedStatement.execute(); //tablo oluþturma,silme,tablo üzerinde deðiþiklik yapma
			logger.info("Personel tablasu baþarýyla oluþturuldu.");
			
		} catch (SQLException e) {
			logger.warn("Personel tablosu oluþturulurken hata meydana geldi.");
		}finally{
