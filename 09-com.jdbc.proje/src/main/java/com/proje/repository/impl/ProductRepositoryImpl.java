...
public class ProductRepositoryImpl implements ProductRepository{
	...
	public Product findProductById(int id) {
		...
		try {
			...
			if(resultSet.next()){
				...
				double unitPrice = resultSet.getDouble("productPrice");
			...
			logger.warn(id + " idli ürün aranýrken hata meydana geldi. HATA : " + e);
		}finally {
	...
	public List<Product> findProducts() {
		...
		try {
			...
			logger.warn("Ürünler listelenirken hata oluþtu. HATA : " + e);
		}finally {
			DBConnection.closeConnection(connection, preparedStatement, resultSet);
		}
		return products;
